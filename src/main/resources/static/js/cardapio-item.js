    ...
    dataTable = $('#data-table').DataTable({
        ...
        buttons: [
            {
                ...
                title: function () { return 'Gestão de Restaurante - Items Cardápio'; },
                exportOptions: {
        ...
        initComplete: function() {
            $('#data-table_length').each(function () {
                $(this).append('<a class="btn btn-success btn-add" href="/cardapio/cardapio-item/cadastro">' +
        ...
        columns: [
            ...
            { "data": "preco" },
            {
                "data": null, "render": function ( data ) {
                    return '<div class="actions"><a class="btn btn-success" href="/cardapio/cardapio-item/visualizar/'+data.id+'">'+
                    '<i class="fas fa-eye"></i> Ver</a>'+
                    '<a class="btn btn-primary" href="/cardapio/cardapio-item/editar/'+data.id+'">'+
