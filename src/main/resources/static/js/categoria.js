        ...
        buttons:[
            {
                ...
                action: function (e, dt, node, config) {
                    window.location.href = '/categoria/cadastro';
                }
            },
            {
                extend:    'pdfHtml5',
                ...
                title: function () { return 'Gestão de Restaurante - Categorias'; },
                exportOptions: {
        ...
        columns: [
            ...
            { "data": "nome" },
            {
                "data": null, "render": function (data) {
                    return '<div class="actions"><a class="btn btn-primary" href="/categoria/editar/'+data.id+'">'+
                    '<i class="fas fa-pen"></i> Editar</a><a class="btn btn-danger" '+
                    'onclick="return confirm(\'Tem certeza que deseja excluir esse registro?\');" '+
                    'href="/categoria/excluir/'+data.id+'"><i class="fas fa-trash"></i> Excluir</a></div>'
                }
            }
        ],
        language: {
