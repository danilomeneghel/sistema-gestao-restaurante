...
INSERT INTO `estabelecimento` VALUES (1,1,'Estabelecimento Teste','email@teste.com','(11)99999-9999','Rua Teste 01',1,1,1);

INSERT INTO `fornecedor` VALUES (1,1,'Fornecedor Teste','email@teste.com','(11)99999-9999','Rua Teste 01',1,1,1);

INSERT INTO `categoria` VALUES (1,'Comida'),(2,'Salgado'),(3,'Bebida'),(4,'Bebida Alcoólica'),(5,'Sobremesa');

INSERT INTO `cardapio` VALUES (1,'Almoço',1),(2,'Janta',1),(3,'Lanche',1),(4,'Café',1);

INSERT INTO `produto` VALUES (1,'Arroz',1),(2,'Feijão',1),(3,'Massa',1),(4,'Batata Frita',1),(5,'Batata Palha',1),(6,'Carne Bovina',1),(7,'Frango',1),(8,'Ovo',1),(9,'Guaraná Antarctica',1),(10,'Coca-cola',1),(11,'Cerveja Skol',1),(12,'Vinho Tinto',1),(13,'Xis Salada',1),(14,'Pudim',1);
